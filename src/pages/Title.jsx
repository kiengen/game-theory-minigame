...
const Title = () => { 
  return (
    <div className="flex bg-c-charcoal justify-center items-center h-full w-full">
      <div className="flex flex-col h-3/4 w-3/4 gap-10 max-h-50 max-w-200">
